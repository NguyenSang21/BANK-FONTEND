...
class InternalTransactionForm extends Component {
          ...
          <Col span={12}>
            <Card headStyle={{background: '#fafafa'}} title="THÔNG TIN NGƯỜI HƯỞNG" style={{width: '100%'}}>
              <Form.Item {...formItemLayout} label="Số tài khoản:">
                ...
                })(<InputNumber style={{width: '100%'}} min={1} max={20000000}
...
const InternalTransaction = Form.create({name: 'validate_other'})(InternalTransactionForm);
