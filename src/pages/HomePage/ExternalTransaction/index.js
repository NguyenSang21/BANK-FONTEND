...
class ExternalTransactionForm extends Component {
  ...
  render() {
    ...
    return (
      <Form {...formItemLayout} onSubmit={this.handleSubmit}>
        <Row gutter={16}>
          <Col span={12}>
            <Card headStyle={{background: '#fafafa'}} title="THÔNG TIN NGƯỜI CHUYỂN" style={{ width: '100%' }}>
              <div>
          ...
          <Col span={12}>
            <Card headStyle={{background: '#fafafa'}} title="THÔNG TIN NGƯỜI HƯỞNG" style={{ width: '100%' }}>
              ...
              <Form.Item {...formItemLayout} label="Số tài khoản:">
                ...
                })(<InputNumber style={{width: '100%'}} min={1} max={20000000} placeholder="Vui lòng nhập số tài khoản!"/>)}
              </Form.Item>
              <Form.Item {...formItemLayout} label="Người hưởng:">
                ...
                })(<Input style={{width: '100%'}} placeholder="Vui lòng nhập tên người hưởng!"/>)}
              </Form.Item>
            </Card>
          </Col>
        </Row>
        <br/>
        <Card headStyle={{background: '#fafafa'}} title="THÔNG TIN GIAO DỊCH" style={{ width: '100%' }}>
          <Form.Item {...formItemLayout} label="Số tiền chuyển:">
            ...
            })(<InputNumber style={{width: '100%'}} min={1} max={20000000} placeholder="Vui lòng nhập số tiền"/>)}
          </Form.Item>
...
const ExternalTransaction = Form.create({ name: 'validate_other' })(ExternalTransactionForm);
